  ...
  return createPortal(
    ...
    >
      ...
      <div className="contact-dialog-inner" data-lenis-prevent>
        ...
        {/* Duas colunas em tela larga, uma em tela estreita: a foto vira uma
            faixa no topo em vez de desaparecer. */}
...
function CorpoModal({
  ...
  return (
    <>
      ...
      <h3 id="contato-modal-titulo" className="contact-dialog-titulo">
        {title}
      </h3>
